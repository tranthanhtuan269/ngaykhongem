            ...
            @foreach ($yeucaunhas as $yeucaunha)
                <tr>
                    ...
                    <td>
                        ...
                        <div class="big-field">Người đăng: {{ $yeucaunha->name }}</div>
                        ...
                        @else
                            ...
                            <div class="big-field"> Đăng tin ngay để tiếp cận khách mua</div>
                            <div class="big-field"> http://chodatso.com/tinbds/create</div>
                        @endif
