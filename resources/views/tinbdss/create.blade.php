...
<div class="form-group">
    ...
    <div class="col-sm-10">
    {!! Form::text('gia', null, ['class' => 'form-control', 'placeholder' => 'Giá ( VNĐ )']) !!}
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-10">
    {!! Form::text('dia_chi', null, ['class' => 'form-control', 'placeholder' => 'Địa chỉ']) !!}
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-10">
    {!! Form::text('tang', null, ['class' => 'form-control', 'placeholder' => 'Số tầng ( tầng )']) !!}
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-10">
    {!! Form::text('phong_ngu', null, ['class' => 'form-control', 'placeholder' => 'Số phòng ngủ ( phòng )']) !!}
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-10">
    {!! Form::text('phong_khach', null, ['class' => 'form-control', 'placeholder' => 'Số phòng khách ( phòng )']) !!}
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-10">
    {!! Form::text('wc', null, ['class' => 'form-control', 'placeholder' => 'Số nhà vệ sinh ( phòng )']) !!}
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="btn btn-default">{{ link_to_route('tinbds.index', 'Danh sách tin') }}</div>
</div>
