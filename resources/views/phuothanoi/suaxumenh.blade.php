...
<div class="panel panel-primary main-content">
    <div class="panel-heading">
        <h3 class="panel-title">Sửa bài xứ mệnh</h3>
    </div>
    ...
    <div class="form-group">
        {!! Form::label('gioi_thieu', 'Xứ mệnh:', ['class' => 'col-sm-2 control-label']) !!}
        <div class="col-sm-10">
  ...
  $('#summernote').summernote({
    ...
    $("#suagioithieu_btn").click(function(){
        ...
        request.done(function( msg ) {
            if(msg.code==1){
                $.toast({
                    text: 'Bạn đã sửa xứ mệnh thành công! Xin cám ơn!', // Text that is to be shown in the toast
                    heading: 'Sửa xứ mệnh thành công', // Optional heading to be shown on the toast
                ...
                $.toast({
                    text: 'Bạn đã sửa xứ mệnh không thành công! <br />Xin hãy liên hệ ban quản trị!', // Text that is to be shown in the toast
                    heading: 'Sửa xứ mệnh không thành công', // Optional heading to be shown on the toast
